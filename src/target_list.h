...
using target_type = types<
    files_target, rule_target, native_target, native_library_target, native_shared_library_target,
    native_static_library_target, executable_target, binary_target, binary_library_target, binary_target_msvc
>;
